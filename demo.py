...
state_dict_com = load_checkpoint(r"E:\Git_repos\end-to-end_compression\checkpoint\image_compressor\image_compressor_00320000", device)
...
print(compressor.encoder.gdn1.gamma[:,0].sum())
